...
- Root cause analysis (Top 3 bug cause analysis)`,
  ...
  'brse-qt-016': {
    ...
    options: [
      ...
      'When checking the logic in which system actions change in complex ways depending on the combination of multiple conditions.',
