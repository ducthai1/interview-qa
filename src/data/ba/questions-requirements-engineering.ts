...
export const requirementsEngineeringQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'The process of discovering requirements by communicating with stakeholders, customers, and other users',
    ...
    tags: ['elicitation', 'discovery', 'stakeholders'],
    year: 2026,
  },
  {
    id: 'ba-re-027',
    ...
    options: [
      ...
      'By categorizing them into Must have, Should have, Could have, and Won\'t have',
    ...
    tags: ['moscow', 'prioritization', 'scope-management'],
    year: 2026,
  },
  {
    id: 'ba-re-028',
    ...
    options: [
      'A requirement that describes how the system should perform (e.g., speed)',
      'A requirement that describes what the system should do (e.g., "The system shall send an email confirmation")',
    ...
    tags: ['functional-requirements', 'system-behavior', 'basics'],
    year: 2026,
  },
  {
    id: 'ba-re-029',
    ...
    options: [
      ...
      'The uncontrolled growth or continuous change in project scope without adjustment to time, cost, and resources',
    ...
    tags: ['scope-creep', 'risk-management', 'change-control'],
    year: 2026,
  },
  {
    id: 'ba-re-030',
    ...
    tags: ['prototyping', 'validation', 'ui-ux'],
    year: 2026,
  },
  {
    id: 'ba-re-031',
    ...
    tags: ['prototyping', 'elicitation', 'visualization'],
    year: 2026,
  },
  {
    id: 'ba-re-032',
  ...
  },
  {
    ...
    tags: ['conflict-resolution', 'stakeholder-alignment', 'negotiation'],
    year: 2026,
  },
  {
    id: 'ba-re-034',
    ...
    tags: ['verifiability', 'quality-requirements', 'testing'],
    year: 2026,
  },
  {
    id: 'ba-re-035',
    ...
    options: [
      ...
      'A formal group of stakeholders responsible for reviewing, evaluating, and approving or rejecting proposed changes to the project scope',
    ...
    tags: ['ccb', 'change-management', 'governance'],
    year: 2026,
  },
]
