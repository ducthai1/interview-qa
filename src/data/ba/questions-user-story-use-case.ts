...
export const userStoryUseCaseQuestions: Question[] = [
  ...
  },
  {
    ...
    tags: ['user-story', 'format', 'business-value'],
    year: 2026,
  },
  {
    id: 'ba-us-015',
    ...
    options: [
      ...
      'Slice the story into smaller, independently deliverable user stories focusing on thin vertical slices of functionality',
    ...
    tags: ['slicing', 'epic', 'sprint-planning'],
    year: 2026,
  },
  {
    id: 'ba-us-016',
  ...
  },
  {
    ...
    answer: 'Hamburger Slicing strategy:\n1. Choose a "Thin Slice": Support only 1 country (e.g., VN) and 1 ID provider (Email/Password) end-to-end.\n2. Breadth Slices: Add other countries one by one (address format differences, local laws).\n3. Depth Slices: Add other ID providers (Google, Facebook, Apple ID).\n4. Enhancement Slices: Add multi-factor authentication or profile picture upload.',
    ...
    tags: ['slicing', 'strategy', 'hamburger-method'],
    year: 2026,
  },
  {
    id: 'ba-us-019',
  ...
  },
  {
    ...
    options: [
      ...
      'The high-level activities that a user performs, sequenced in chronological order to describe the user journey',
    ...
    tags: ['story-mapping', 'user-journey'],
    year: 2026,
  },
  {
    id: 'ba-us-021',
    ...
    options: [
      ...
      'Include them as Acceptance Criteria on relevant stories, or as part of the "Definition of Done" for the entire project',
  ...
  },
  {
    ...
    options: [
      ...
      'A story from the perspective of an attacker or a user making common mistakes, used to define security or error-handling requirements',
    ...
    tags: ['abuser-story', 'security', 'quality'],
    year: 2026,
  },
  {
    id: 'ba-us-023',
    ...
    tags: ['workshop', 'collaboration', 'lead'],
    year: 2026,
  },
  {
    id: 'ba-us-024',
    ...
    tags: ['user-story', 'templates', 'agile-basics'],
    year: 2026,
  },
  {
    id: 'ba-us-025',
    ...
    tags: ['3cs', 'user-story-quality', 'collaboration'],
    year: 2026,
  },
  {
    id: 'ba-us-026',
    ...
    tags: ['use-case-diagram', 'uml', 'actors'],
    year: 2026,
  },
  {
    id: 'ba-us-027',
    ...
    tags: ['uml', 'include-vs-extend', 'use-case-modeling'],
    year: 2026,
  },
  {
    id: 'ba-us-028',
    ...
    tags: ['user-story', 'collaboration', 'agile-philosophy'],
    year: 2026,
  },
  {
    id: 'ba-us-029',
    ...
    options: [
      'Dividing stories by technical layer (e.g., UI, DB)',
    ...
    tags: ['vertical-slicing', 'value-delivery', 'story-splitting'],
    year: 2026,
  },
  {
    id: 'ba-us-030',
    ...
    options: [
      ...
      'A fictional character that represents a typical user segment, helping the team understand their goals, behaviors, and pain points',
    ...
    tags: ['personas', 'user-research', 'empathy'],
    year: 2026,
  },
  {
    id: 'ba-us-031',
    ...
    tags: ['nfr', 'non-functional-requirements', 'agile'],
    year: 2026,
  },
  {
    id: 'ba-us-032',
    ...
    options: [
      ...
      'To visually organize stories to understand the user journey, identify gaps, and plan releases',
    ...
    tags: ['story-mapping', 'user-journey', 'backlog-visualization'],
    year: 2026,
  },
  {
    id: 'ba-us-033',
    ...
    options: [
      'Independent, Negotiable, Valuable, Estimable, Small, Testable',
      'Interesting, New, Variable, Easy, Simple, Traditional',
      'Involved, Noble, Visual, Effective, Secure, Timely',
      'Inside, Near, Very, Every, Some, Today',
    ],
    answer: 0,
    ...
    tags: ['invest', 'quality', 'definition'],
    year: 2026,
  },
]
