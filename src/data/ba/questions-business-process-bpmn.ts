...
export const businessProcessBpmnQuestions: Question[] = [
  ...
  },
  {
    ...
    tags: ['inclusive-gateway', 'branching', 'bpmn-logic'],
    year: 2026,
  },
  {
    id: 'ba-bp-012',
    ...
    options: [
      ...
      'To catch a message while an activity is in progress, potentially interrupting it',
    ...
    tags: ['boundary-event', 'message-event', 'exception-handling'],
    year: 2026,
  },
  {
    id: 'ba-bp-013',
    ...
    tags: ['pools', 'lanes', 'organizations'],
    year: 2026,
  },
  {
    id: 'ba-bp-014',
    ...
    tags: ['compensation', 'rollback', 'transactional-processes'],
    year: 2026,
  },
  {
    id: 'ba-bp-015',
    ...
    tags: ['service-task', 'automation', 'system-interaction'],
    year: 2026,
  },
  {
    id: 'ba-bp-016',
    ...
    tags: ['compensation-event', 'transactional-processes', 'advanced-bpmn'],
    year: 2026,
  },
  {
    id: 'ba-bp-017',
    ...
    options: [
      'Pools are for swimming, Lanes for running',
      'A Pool represents a major participant (e.g., an organization), while Lanes subdivide a Pool (e.g., departments or roles within that organization)',
      'Pools are vertical, Lanes are horizontal',
    ...
    tags: ['pools-vs-lanes', 'collaboration', 'structure'],
    year: 2026,
  },
  {
    id: 'ba-bp-018',
    ...
    tags: ['message-flow', 'collaboration', 'connectors'],
    year: 2026,
  },
  {
    id: 'ba-bp-019',
    ...
    options: [
      ...
      'The task is a "Sub-process" that contains hidden, more detailed steps',
    ...
    tags: ['sub-process', 'abstraction', 'hierarchy'],
    year: 2026,
  },
  {
    id: 'ba-bp-020',
    ...
    tags: ['ad-hoc', 'knowledge-work', 'flexibility'],
    year: 2026,
  },
]
